...
mixin _$ForgotPasswordState {
 ...
 String get email; bool get isLoading; bool get emailSent; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,email,isLoading,emailSent,errorMessage);

@override
String toString() {
  return 'ForgotPasswordState(email: $email, isLoading: $isLoading, emailSent: $emailSent, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String email, bool isLoading, bool emailSent, String? errorMessage
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? isLoading = null,Object? emailSent = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  bool isLoading,  bool emailSent,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isLoading,_that.emailSent,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  bool isLoading,  bool emailSent,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.email,_that.isLoading,_that.emailSent,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  bool isLoading,  bool emailSent,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isLoading,_that.emailSent,_that.errorMessage);case _:
  return null;
...
class _ForgotPasswordState implements ForgotPasswordState {
  const _ForgotPasswordState({this.email = '', this.isLoading = false, this.emailSent = false, this.errorMessage});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? isLoading = null,Object? emailSent = null,Object? errorMessage = freezed,}) {
