...
mixin _$SignInState {
 ...
 String get email; String get password; bool get isLoading; bool get obscurePassword; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,email,password,isLoading,obscurePassword,errorMessage);

@override
String toString() {
  return 'SignInState(email: $email, password: $password, isLoading: $isLoading, obscurePassword: $obscurePassword, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String email, String password, bool isLoading, bool obscurePassword, String? errorMessage
});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? isLoading = null,Object? obscurePassword = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  bool isLoading,  bool obscurePassword,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.email,_that.password,_that.isLoading,_that.obscurePassword,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  bool isLoading,  bool obscurePassword,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _SignInState():
return $default(_that.email,_that.password,_that.isLoading,_that.obscurePassword,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  bool isLoading,  bool obscurePassword,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.email,_that.password,_that.isLoading,_that.obscurePassword,_that.errorMessage);case _:
  return null;
...
class _SignInState implements SignInState {
  const _SignInState({this.email = '', this.password = '', this.isLoading = false, this.obscurePassword = true, this.errorMessage});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? isLoading = null,Object? obscurePassword = null,Object? errorMessage = freezed,}) {
